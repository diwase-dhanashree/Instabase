...
<head>
    ...
    <title><?= $this->pageTitle ? $this->pageTitle . ' - ' : '' ?><?= SITE_NAME ?></title>
    <!-- Styles -->
    ...
    .sidebar-menu li.header, .sidebar-menu li a { font-size: 15px; }
    .sidebar-menu li.header { font-size: 16px; font-weight: 600; letter-spacing: 1px; }
    </style>
</head>
